 ...
 * 天地图矢量图层 地形
 */
public class TianDituVectorTileSource extends XYTileSourceCoordinateSystem {

    /**
     * 获取天地图矢量图层  - 地形
     */
    public static TilesOverlay getTilesOverlays(Context context) {
        MapTileProviderBasic noteTileProviders = new MapTileProviderBasic(context,new TianDituVectorTileSource());
    ...
    public TianDituVectorTileSource() {
        super("TianDitu-Vector", 1, 22, 256, "png",
                new String[]{
                        "https://t0.tianditu.gov.cn/vec_w/wmts?",
                        "https://t1.tianditu.gov.cn/vec_w/wmts?",
                        "https://t2.tianditu.gov.cn/vec_w/wmts?",
                        "https://t3.tianditu.gov.cn/vec_w/wmts?",
                        "https://t4.tianditu.gov.cn/vec_w/wmts?",
                        "https://t5.tianditu.gov.cn/vec_w/wmts?",
                        "https://t6.tianditu.gov.cn/vec_w/wmts?",
    ...
    public String getTileURLString(final long pMapTileIndex) {
      /*  String urlString = getBaseUrl() +
        ...
        String urlString = new StringBuilder()
                .append(getBaseUrl())
                .append("SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=vec&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles")
                .append("&tk=")
