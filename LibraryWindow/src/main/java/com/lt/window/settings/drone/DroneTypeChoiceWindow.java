package com.lt.window.settings.drone;
 ...
 * 无人机失控行为Window
 */
public final class DroneTypeChoiceWindow extends BasePopupWindow<DroneTypeChoiceWindow> {

    private ICallBack<Integer> callback;

    public DroneTypeChoiceWindow(Context context) {
        super(context);
    }

    @Override
    protected void initAttributes() {
        @SuppressLint("InflateParams") View contentView = inflater.inflate(R.layout.module_window_window_settings_choice_flight, null);
