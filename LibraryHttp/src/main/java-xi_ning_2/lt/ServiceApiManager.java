...
public class ServiceApiManager {
    ...
    public Flowable<String> requestUploadAircraftState(AircraftStateRequest request) {
        return com.lt.ServiceCacheApiManager.getInstance().request(request, UrlConfig.UPLOAD_AIRCRAFT_INFO)
                .subscribeOn(RxSchedulers.request())
                .observeOn(RxSchedulers.main());
...
//                .observeOn(RxSchedulers.main());
    ...
    public Flowable<String> requestUpdateOrderState(OrderDeviceStateRequest request) {
        return com.lt.ServiceCacheApiManager.getInstance().request(request, UrlConfig.ORDER_UPDATE_STATE)
                .subscribeOn(RxSchedulers.request())
                .observeOn(RxSchedulers.main());
...
//                .observeOn(RxSchedulers.main());
    ...
    public Flowable<String> requestData(RequestEntity request) {
        return com.lt.ServiceCacheApiManager.getInstance().requestData(request,request.requestPath)
                .subscribeOn(RxSchedulers.request())
                .observeOn(RxSchedulers.main());
    }
    /**
